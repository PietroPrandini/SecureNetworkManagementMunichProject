\begin{longtable}{|l|l|l|l|l|l|p{5cm}|}
  ...
  \hline
   \cellcolor{yellow} 70 & \cellcolor{yellow} 0.142693000 & \cellcolor{yellow} 192.168.62.60 & \cellcolor{yellow} 192.168.40.11 & \cellcolor{yellow} ICMP & \cellcolor{yellow} 54 & \cellcolor{yellow} Echo (ping) request  id=0x0000, seq=0/0, ttl=64 (reply in 79) \\
  \hline
   \cellcolor{yellow} 79 & \cellcolor{yellow} 0.143540000 & \cellcolor{yellow} 192.168.40.11 & \cellcolor{yellow} 192.168.62.60 & \cellcolor{yellow} ICMP & \cellcolor{yellow} 62 & \cellcolor{yellow} Echo (ping) reply    id=0x0000, seq=0/0, ttl=61 (request in 70) \\
  \hline
  ...
  \hline
  \cellcolor{yellow} 313 & \cellcolor{yellow} 0.639452000 & \cellcolor{yellow} 192.168.62.60 & \cellcolor{yellow} 192.168.40.50 & \cellcolor{yellow} ICMP & \cellcolor{yellow} 62 & \cellcolor{yellow} Echo (ping) request  id=0x0000, seq=0/0, ttl=60 (reply in 314) \\
  \hline
  \cellcolor{yellow} 314 & \cellcolor{yellow} 0.639552000 & \cellcolor{yellow} 192.168.40.50 & \cellcolor{yellow} 192.168.62.60 & \cellcolor{yellow} ICMP & \cellcolor{yellow} 62 & \cellcolor{yellow} Echo (ping) reply    id=0x0000, seq=0/0, ttl=64 (request in 313) \\
  \hline
