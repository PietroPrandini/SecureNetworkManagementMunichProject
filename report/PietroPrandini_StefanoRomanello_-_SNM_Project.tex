...
frame=single,
showstringspaces=false} % Listing parameters

\usepackage{hyperref} % Used for external links

\usepackage{longtable} % Used for wireshark tables

\usepackage[table]{xcolor} % Used to highlight some cells of tables
...
\tableofcontents % Shows the index
\clearpage
...
\input{tex/DropCommunication.tex}
\clearpage
